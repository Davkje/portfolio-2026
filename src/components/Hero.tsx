export default function Hero() {
	return (
		<section className="flex flex-col justify-between items-center relative bg-(--main-1) w-full min-h-dvh">
			<div className="absolute right-6 top-20 flex items-center gap-4 text-foreground">
				<a
